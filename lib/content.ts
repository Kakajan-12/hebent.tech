...
export const PROJECT_BASES: ProjectBase[] = [
  ...
  },
  {
    ...
    customer: "Customer name9",
    webSite: "website9",
  },
];

export function expandProjects(): Project[] {
