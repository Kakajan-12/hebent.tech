...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 bg-black opacity-60 transition duration-300 lg:opacity-0 lg:group-hover:opacity-60"
      />
      <div
        className="pointer-events-none absolute inset-0 flex flex-col justify-center items-center p-5 opacity-100 transition duration-300 lg:opacity-0 lg:group-hover:opacity-100"
      >
